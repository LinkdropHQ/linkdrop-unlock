...
import { jsonRpcUrl, apiHost, factory, claimHost, infuraPk } from 'app.config.js'
...
const generator = function * ({ payload }) {
  try {
    ...
    const sdk = initializeSdk({ claimHost, factoryAddress: factory, chainId: networkName, linkdropMasterAddress: selectedAddress, jsonRpcUrl: `${jsonRpcUrl}/v3/${infuraPk}`, apiHost })
