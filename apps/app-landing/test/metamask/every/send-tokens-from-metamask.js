...
import tokenContract from 'mocks/token-contract.js'
const provider = createMockProvider()
const web3Obj = new Web3Mock(provider)
...
describe('data/store/saga/metamask/every/send-tokens-from-metamask.js send assets with metamask', () => {
  ...
  it('get token contract data', () => {
    expect(
      ...
      tokenContract.transfer.getData(toWallet, balanceFormatted, { from: account })
    )
  })
