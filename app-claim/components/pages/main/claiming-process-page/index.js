...
class ClaimingProcessPage extends React.Component {
  componentDidMount () {
    ...
    const { token, amount, expirationTime, linkKey, senderAddress, senderSignature } = getHashVariables({})
    ...
    this.actions().tokens.claimTokens({ wallet, token, tokenAmount: amount, expirationTime, linkKey, senderAddress, senderSignature })
  }
